         ...
         <div class="row">
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="contact-block mb-4 mb-lg-0">
                    ...
                    <h5>Call Us</h5>
                    <a href="tel:03475055405">0347-5055405</a>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="contact-block mb-4 mb-lg-0">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section-title text-center">
                    ...
                    <p class="mb-5">We’re happy to answer any question you have or provide you with more information.</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form id="" class="" method="post" action="{{route('frontend.contact.post')}}">
                    @csrf
                 <!-- form message -->
{{--                    <div class="row">--}}
{{--                        <div class="col-12">--}}
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input name="full_name" id="name" type="text" class="form-control" placeholder="Your Full Name" >
                            </div>
                        </div>
