...
<section class="section about-page">
	<div class="container">
		<div class="row">
			<div class="col-lg-4">
				<h2 class="title-color">Personal care for your living items</h2>
			</div>
			<div class="col-lg-8">
				<p>The appliances in your home are among the most important parts of your house, and they will need repairs at some point even if they are taken care of. Make sure to hire only an experienced technician to fix your refrigerator, oven, stove, washer, dryer, or any other appliance in your home. If you have trouble with an appliance in your home, call UstadHere; we'll diagnose and fix it for you!</p>
...
<section class="section awards">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-4">
				<h2 class="title-color">Our Recent Projects </h2>
