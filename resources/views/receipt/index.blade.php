...
<table class="head container">
    <tr>
        ...
        <td class="shop-info">
            <div class="shop-name">
{{--                <h3>UstadHere</h3>--}}
                            <img style="align-items: center; width:300px; height:40px;" alt="Ustadhere" src="{{asset('assets/logo/logo.png')}}"  />
            </div>
...
<table class="order-data-addresses">
    <tr>
        <td class="address billing-address">
            ...
            <br>
            <p class="pt-2">{{$appointment->name ?? ''}}</p>
            <p class="">{{$appointment->phone ?? ''}}</p>
            <p class="">{{$appointment->email ?? ''}}</p>
            <p class="">{{$appointment->address ?? ''}}</p>
        </td>
...
{{--                </tr>--}}
                <tr class="order_total">
                    ...
                    <td class="price"><span class="totals-price"><span class="amount">Rs. {{$invoice->amount ?? ''}}</span></span></td>
                </tr>
                </tfoot>
            </table>
        </td>
